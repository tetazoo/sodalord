...
/* Define if gnuplot has frames. */
/* #undef GNUPLOT_HAS_FRAMES */

/* Define if gnuplot has multiplot. */
...
/* Define to 1 if you have the `glob' library (-lglob). */
/* #undef HAVE_LIBGLOB */
...
/* Define this to be the path separator for your system */
#define SEPCHAR 1
...
/* Define if using dlopen/dlsym. */
#define WITH_DL 1

/* Define if using dynamic linking. */
#define WITH_DYNAMIC_LINKING 1

/* Define if using dld for dynamic linking. */
/* #undef WITH_SHL */
