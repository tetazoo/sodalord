...
#
## Package name      : perl5
## Source directory  : /root/.cpan/build/perl-5.8.0
## Configuration time: Mon Aug 12 23:49:22 EDT 2002
## Configured by     : davidmac
## Target system     : linux crystal-clear.mit.edu 2.4.9-31 #1 tue feb 26 07:11:02 est 2002 i686 unknown 
#
## Configure command line arguments.
#PERL_PATCHLEVEL=

my $config_sh = <<'!END!';
archlibexp='/usr/local/lib/perl5/5.8.0/i686-linux'
archname='i686-linux'
cc='cc'
...
ar='ar'
archlib='/usr/local/lib/perl5/5.8.0/i686-linux'
archname64=''
archobjs=''
asctime_r_proto='0'
awk='awk'
...
ccname='gcc'
ccsymbols='__GNUC_MINOR__=96 __GNUC_PATCHLEVEL__=0 __NO_INLINE__=1 __i386=1 __i386__=1 __linux=1 __linux__=1 __tune_i386__=1 __unix=1 __unix__=1 cpu=i386 machine=i386 system=posix'
ccversion=''
cf_by='davidmac'
cf_email='davidmac@crystal-clear.mit.edu'
cf_time='Mon Aug 12 23:49:22 EDT 2002'
charsize='1'
chgrp=''
chmod='chmod'
chown=''
...
comm='comm'
compress=''
config_arg0='/root/.cpan/build/perl-5.8.0/Configure'
config_argc='0'
config_args=''
contains='grep'
cp='cp'
...
cpprun='cc -E'
cppstdin='cc -E'
cppsymbols='_FILE_OFFSET_BITS=64 __GLIBC__=2 __GLIBC_MINOR__=2 __GNUC_MINOR__=96 __GNU_LIBRARY__=6 _LARGEFILE_SOURCE=1 _POSIX_C_SOURCE=199506 _POSIX_SOURCE=1 __STDC__=1 __USE_BSD=1 __USE_FILE_OFFSET64=1 __USE_LARGEFILE=1 __USE_MISC=1 __USE_POSIX=1 __USE_POSIX199309=1 __USE_POSIX199506=1 __USE_POSIX2=1 __USE_SVID=1 __i386=1 __i386__=1 __linux=1 __linux__=1 __unix=1 __unix__=1'
crypt_r_proto='0'
cryptlib=''
csh='csh'
ctermid_r_proto='0'
...
full_sed='/bin/sed'
gccosandvers=''
gccversion='2.96 20000731 (Red Hat Linux 7.1 2.96-85)'
getgrent_r_proto='0'
getgrgid_r_proto='0'
getgrnam_r_proto='0'
...
libsfiles=' libnsl.so libndbm.so libgdbm.so libdb.so libdl.so libm.so libc.so libcrypt.so libutil.so'
libsfound=' /usr/lib/libnsl.so /usr/lib/libndbm.so /usr/lib/libgdbm.so /lib/libdb.so /usr/lib/libdl.so /usr/lib/libm.so /usr/lib/libc.so /usr/lib/libcrypt.so /usr/lib/libutil.so'
...
mydomain='.mit.edu'
myhostname='crystal-clear'
myuname='linux crystal-clear.mit.edu 2.4.9-31 #1 tue feb 26 07:11:02 est 2002 i686 unknown '
n='-n'
need_va_copy='undef'
...
patchlevel='8'
path_sep=':'
perl5='/usr/athena/bin/perl'
perl=''
perl_patchlevel=''
perladmin='davidmac@crystal-clear.mit.edu'
...
sig_size='68'
signal_t='void'
sitearch='/usr/local/lib/perl5/site_perl/5.8.0/i686-linux'
...
srand48_r_proto='0'
srandom_r_proto='0'
src='/root/.cpan/build/perl-5.8.0'
ssizetype='ssize_t'
