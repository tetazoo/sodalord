 ...
 * contents of ReadKey.xs. Do not edit this file, edit ReadKey.xs instead.
 *
...
#line 1666 "ReadKey.c"
XS(XS_Term__ReadKey_selectfile); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_selectfile)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::selectfile(file, delay)");
    {
	InputStream	file = IoIFP(sv_2io(ST(0)));
	double	delay = (double)SvNV(ST(1));
	int	RETVAL;
	dXSTARG;

	RETVAL = selectfile(file, delay);
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}

XS(XS_Term__ReadKey_SetReadMode); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_SetReadMode)
{
    dXSARGS;
    if (items < 1 || items > 2)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::SetReadMode(mode, file=STDIN)");
    {
	...
	if (items < 2)
	    ...
	    file = IoIFP(sv_2io(ST(1)));
	}
#line 1669 "ReadKey.xs"
	{
		ReadMode(file,mode);
	}
#line 1704 "ReadKey.c"
...
XS(XS_Term__ReadKey_setnodelay); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_setnodelay)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::setnodelay(file, mode)");
    {
	InputStream	file = IoIFP(sv_2io(ST(0)));
	...
	RETVAL = setnodelay(file, mode);
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}

XS(XS_Term__ReadKey_pollfile); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_pollfile)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::pollfile(file, delay)");
    {
	InputStream	file = IoIFP(sv_2io(ST(0)));
	double	delay = (double)SvNV(ST(1));
	int	RETVAL;
	...
	RETVAL = pollfile(file, delay);
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}

XS(XS_Term__ReadKey_Win32PeekChar); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_Win32PeekChar)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::Win32PeekChar(file, delay)");
    {
	InputStream	file = IoIFP(sv_2io(ST(0)));
	double	delay = (double)SvNV(ST(1));
	SV *	RETVAL;
#line 1688 "ReadKey.xs"
	{
		char key;
...
XS(XS_Term__ReadKey_blockoptions); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_blockoptions)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::blockoptions()");
    {
	int	RETVAL;
	dXSTARG;
...
XS(XS_Term__ReadKey_termoptions); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_termoptions)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::termoptions()");
    {
	int	RETVAL;
	dXSTARG;
...
XS(XS_Term__ReadKey_termsizeoptions); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_termsizeoptions)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::termsizeoptions()");
    {
	int	RETVAL;
	dXSTARG;

	RETVAL = termsizeoptions();
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}

XS(XS_Term__ReadKey_GetTermSizeWin32); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_GetTermSizeWin32)
{
    dXSARGS;
    if (items < 0 || items > 1)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::GetTermSizeWin32(file=STDIN)");
    SP -= items;
    {
	InputStream	file;
...
XS(XS_Term__ReadKey_GetTermSizeVIO); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_GetTermSizeVIO)
{
    dXSARGS;
    if (items < 0 || items > 1)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::GetTermSizeVIO(file=STDIN)");
    SP -= items;
    {
	InputStream	file;
...
XS(XS_Term__ReadKey_GetTermSizeGWINSZ); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_GetTermSizeGWINSZ)
{
    dXSARGS;
    if (items < 0 || items > 1)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::GetTermSizeGWINSZ(file=STDIN)");
    SP -= items;
    {
	InputStream	file;
...
XS(XS_Term__ReadKey_GetTermSizeGSIZE); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_GetTermSizeGSIZE)
{
    dXSARGS;
    if (items < 0 || items > 1)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::GetTermSizeGSIZE(file=STDIN)");
    SP -= items;
    {
	InputStream	file;
...
XS(XS_Term__ReadKey_SetTerminalSize); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_SetTerminalSize)
{
    dXSARGS;
    if (items < 4 || items > 5)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::SetTerminalSize(width, height, xpix, ypix, file=STDIN)");
    {
	int	width = (int)SvIV(ST(0));
	int	height = (int)SvIV(ST(1));
	int	xpix = (int)SvIV(ST(2));
	int	ypix = (int)SvIV(ST(3));
	InputStream	file;
	int	RETVAL;
	dXSTARG;
	...
	if (items < 5)
	    ...
	    file = IoIFP(sv_2io(ST(4)));
	}
#line 1795 "ReadKey.xs"
	{
...
XS(XS_Term__ReadKey_GetSpeed); /* prototype to pass -Wmissing-prototypes */
XS(XS_Term__ReadKey_GetSpeed)
{
    dXSARGS;
    if (items < 0 || items > 1)
	Perl_croak(aTHX_ "Usage: Term::ReadKey::GetSpeed(file=STDIN)");
    SP -= items;
    {
	InputStream	file;
...
extern "C"
#endif
XS(boot_Term__ReadKey); /* prototype to pass -Wmissing-prototypes */
XS(boot_Term__ReadKey)
{
    dXSARGS;
    char* file = __FILE__;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("Term::ReadKey::selectfile", XS_Term__ReadKey_selectfile, file);
        newXS("Term::ReadKey::SetReadMode", XS_Term__ReadKey_SetReadMode, file);
        newXS("Term::ReadKey::setnodelay", XS_Term__ReadKey_setnodelay, file);
        newXS("Term::ReadKey::pollfile", XS_Term__ReadKey_pollfile, file);
        newXS("Term::ReadKey::Win32PeekChar", XS_Term__ReadKey_Win32PeekChar, file);
        newXS("Term::ReadKey::blockoptions", XS_Term__ReadKey_blockoptions, file);
        newXS("Term::ReadKey::termoptions", XS_Term__ReadKey_termoptions, file);
        newXS("Term::ReadKey::termsizeoptions", XS_Term__ReadKey_termsizeoptions, file);
        newXS("Term::ReadKey::GetTermSizeWin32", XS_Term__ReadKey_GetTermSizeWin32, file);
        newXS("Term::ReadKey::GetTermSizeVIO", XS_Term__ReadKey_GetTermSizeVIO, file);
        newXS("Term::ReadKey::GetTermSizeGWINSZ", XS_Term__ReadKey_GetTermSizeGWINSZ, file);
        newXS("Term::ReadKey::GetTermSizeGSIZE", XS_Term__ReadKey_GetTermSizeGSIZE, file);
        newXS("Term::ReadKey::SetTerminalSize", XS_Term__ReadKey_SetTerminalSize, file);
        newXS("Term::ReadKey::GetSpeed", XS_Term__ReadKey_GetSpeed, file);

    /* Initialisation Section */

#line 1821 "ReadKey.xs"
