...
#define OCTAVE_CONF_ALL_CFLAGS "-I. -I.. -I../liboctave -I../src -I../libcruft/misc  -I../glob -I../glob -DHAVE_CONFIG_H -mieee-fp -g -O2"
#endif

#ifndef OCTAVE_CONF_ALL_CXXFLAGS
#define OCTAVE_CONF_ALL_CXXFLAGS "-I. -I.. -I../liboctave -I../src -I../libcruft/misc  -I../glob -I../glob -DHAVE_CONFIG_H -mieee-fp -fno-implicit-templates -g -O2 -Wall"
#endif
...
#define OCTAVE_CONF_ALL_LDFLAGS "-L..  -fPIC -g"
#endif
...
#define OCTAVE_CONF_CC_VERSION "2.96 20000731 (Red Hat Linux 7.3 2.96-110)"
#endif
...
#define OCTAVE_CONF_CXXFLAGS "-g -O2 -Wall"
#endif
...
#define OCTAVE_CONF_CXX_VERSION "2.96 20000731 (Red Hat Linux 7.3 2.96-110)"
#endif
...
#define OCTAVE_CONF_FLIBS "-L/usr/lib/gcc-lib/i386-redhat-linux/2.96 -L/usr/lib/gcc-lib/i386-redhat-linux/2.96/../../.. -lg2c -lm"
#endif
...
#define OCTAVE_CONF_LIBKPATHSEA "../kpathsea/libkpathsea.a"
#endif

#ifndef OCTAVE_CONF_LIBOCT_PATHSEARCH
#define OCTAVE_CONF_LIBOCT_PATHSEARCH "../liboctave/liboct-pathsearch.a"
#endif

#ifndef OCTAVE_CONF_LIBOCT_READLINE
#define OCTAVE_CONF_LIBOCT_READLINE "../liboctave/liboct-readline.a"
#endif
...
#define OCTAVE_CONF_LIBS "-lreadline  -lncurses -ldl -lm "
#endif
...
#define OCTAVE_CONF_MKOCTFILE_INCFLAGS "-I/usr/local/include/octave-2.1.36 -I/usr/local/include/octave-2.1.36/octave -I/usr/local/include"
#endif

#ifndef OCTAVE_CONF_MKOCTFILE_LFLAGS
#define OCTAVE_CONF_MKOCTFILE_LFLAGS "-L/usr/local/lib/octave-2.1.36"
#endif

#ifndef OCTAVE_CONF_OCTAVE_LITE
#define OCTAVE_CONF_OCTAVE_LITE "false"
#endif
...
#define OCTAVE_CONF_RLD_FLAG "-Xlinker -rpath -Xlinker /usr/local/lib/octave-2.1.36"
#endif
...
#define OCTAVE_CONF_SHLEXT_VER "so.2.1.36"
#endif
...
#define OCTAVE_CONF_SONAME_FLAGS "-Xlinker -soname -Xlinker oct-conf.h"
#endif
...
#define OCTAVE_CONF_WITH_DL "true"
#endif

#ifndef OCTAVE_CONF_WITH_DYNAMIC_LINKING
#define OCTAVE_CONF_WITH_DYNAMIC_LINKING "true"
#endif

#ifndef OCTAVE_CONF_WITH_SHL
#define OCTAVE_CONF_WITH_SHL "false"
#endif
...
#define OCTAVE_CONF_XTRA_CXXFLAGS "-mieee-fp -fno-implicit-templates"
#endif
