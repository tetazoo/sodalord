// DO NOT EDIT!
// Generated automatically from ODESSA-opts.in.

#if !defined (octave_ODESSA_options_h)
#define octave_ODESSA_options_h 1
...
public:
  ...
  void set_options (const ODESSA_options& opt) { copy (opt); }
